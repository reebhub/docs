...
| **from**  | `Date` | Delete the range of time series entries starting from this timestamp (inclusive).<br>Pass `null` to use the minimum date value. |
| **to**    | `Date` | Delete the range of time series entries ending at this timestamp (inclusive).<br>Pass `null` to use the maximum date value.     |
