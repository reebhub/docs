...
| **from**  | `DateTime?` | Delete the range of time series entries starting from this timestamp (inclusive).<br>Default: `DateTime.MinValue` |
| **to**    | `DateTime?` | Delete the range of time series entries ending at this timestamp (inclusive).<br>Default: `DateTime.MaxValue`     |
